# -*- coding: utf-8 -*-
# @Time : 2022/10/11 17:09
# @Author : xiaozhou
# @FileName: network_34_demo02_singleswin_边缘.py
# @Software: PyCharm
...
from mynets.transformer import swin_transformer
from torchvision.models.resnet import resnet34
import torch.nn.functional as F

# resnet = resnet34(pretrained=True)
resnet = resnet34()
# resweights_dict=torch.load('/home/zmk/deeplearning/Dataset_BUSI_重新开始/mynets/CNN/resnet34-b627a593.pth',map_location=device)
resweights_dict=torch.load('/home/zmk/deeplearning/Dataset_BUSI_重新开始_upup/mynets/CNN/resnet34-b627a593.pth',map_location=device)
resnet.load_state_dict(resweights_dict, strict=False)
# del resnet.avgpool
# del resnet.fc
# # 查看resnet50的结构
# for x, y in resnet.named_children():
#     print(x)

swin = swin_transformer.swin_tiny_patch4_window7_224()

weights_dict = torch.load('/home/zmk/deeplearning/Dataset_BUSI_重新开始_upup/mynets/transformer/swin_tiny_patch4_window7_224.pth', map_location=device)["model"]
# weights_dict = torch.load('./transformer/swin_tiny_patch4_window7_224.pth', map_location=device)["model"]
# 删除有关分类类别的权重
# for k in list(weights_dict.keys()):
#     if "head" in k:
#         del weights_dict[k]
swin.load_state_dict(weights_dict, strict=False)
...
class crossBlock(nn.Module):
    def __init__(self, channels):
        ...
        # self.agv = nn.AdaptiveAvgPool2d(1)
        # self.conv1 = nn.Conv2d(in_channels=channels, out_channels=channels, kernel_size=1)
        # self.conv1 = nn.Conv2d(in_channels=channels, out_channels=channels, kernel_size=1)
        # self.con=nn.Conv2d(2*channels,channels,kernel_size=1)


        self.dilation1 = nn.Sequential(SeparableConv2d(width, width, kernel_size=3, padding=1, dilation=1, bias=False),
...
class net1(nn.Module):
    def __init__(self, num_class=2):
        ...
        # self.tiaozheng = tiaozheng

        self.convx = Conv(96, 64, bn=True, relu=True)
        ...
        # self.conv6=ConvBNReLU(96*2,256)
        self.conv6=ConvBNReLU(96,96)
        # self.conv7=ConvBNReLU(192,96)
        # self.conv7=ConvBNReLU(192*2,256)
        self.conv7=ConvBNReLU(192,192)
        # self.conv8=ConvBNReLU(384,96)
        self.conv8=ConvBNReLU(384,384)
        # self.conv8=ConvBNReLU(384*2,256)
        # self.conv9=ConvBNReLU(768,96)
        # self.conv9=ConvBNReLU(768*2,256)
        self.conv9=ConvBNReLU(768,768)
